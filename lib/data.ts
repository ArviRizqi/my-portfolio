...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Architecture", value: "XGBoost Classifier" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Platform", value: "Streamlit" },
      { label: "Architecture", value: "Random Forest" },
    ],
  ...
  },
  {
    ...
    typeColor: "orange",
    emoji: "📊",
    tagline: "Machine learning model to estimate house prices based on property features",
    problem: "Determining accurate house prices can be complex due to multiple influencing factors such as location, size, and property characteristics.",
    solution: "Developed a House Price Prediction model using tabular data, including data preprocessing, exploratory data analysis (EDA), and feature engineering. Implemented machine learning models to learn patterns and built an interactive app using Streamlit for real-time predictions.",
    result: "An end-to-end predictive application that allows users to input property features and instantly receive estimated house prices, making the model accessible to non-technical users.",
    metrics: [
      { label: "Platform", value: "Streamlit" },
      { label: "Architecture", value: "Gradient Boosting" },
    ],
